            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="p-5">
                        ...
                        <section>
                            <form wire:submit.prevent="update({{ $data->id }})" method="POST">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" wire:model.lazy="description" id="description" cols="15" rows="5" class="form-control @error('description') is-invalid @enderror"></textarea>
